...
class re_rightface_frontcameraPage extends StatefulWidget {
  const re_rightface_frontcameraPage({
    Key? key,
  ...
  @override
  re_rightface_frontcameraPageState createState() =>
      re_rightface_frontcameraPageState();
}

class re_rightface_frontcameraPageState
    extends State<re_rightface_frontcameraPage> {
            ...
            children: [
              ...
              FloatingActionButton(
                onPressed: () async {
                  Navigator.of(context).push(
                    MaterialPageRoute(
                      builder: (context) => re_rightface_backcameraPage(
