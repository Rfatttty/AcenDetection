...
class re_leftface_frontcameraPage extends StatefulWidget {
  const re_leftface_frontcameraPage(
      {Key? key,
  ...
  @override
  re_leftface_frontcameraPageState createState() =>
      re_leftface_frontcameraPageState();
}

class re_leftface_frontcameraPageState
    extends State<re_leftface_frontcameraPage> {
            ...
            children: [
              ...
              FloatingActionButton(
                onPressed: () async {
                  Navigator.of(context).push(
                    MaterialPageRoute(
                      builder: (context) => re_leftface_backcameraPage(
