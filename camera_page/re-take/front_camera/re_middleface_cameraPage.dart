...
class re_middleface_frontcameraPage extends StatefulWidget {
  const re_middleface_frontcameraPage(
      {Key? key,
  ...
  @override
  re_middleface_frontcameraPageState createState() =>
      re_middleface_frontcameraPageState();
}

class re_middleface_frontcameraPageState
    extends State<re_middleface_frontcameraPage> {
            ...
            children: [
              ...
              FloatingActionButton(
                onPressed: () async {
                  Navigator.of(context).push(
                    MaterialPageRoute(
                      builder: (context) => re_middleface_backcameraPage(
