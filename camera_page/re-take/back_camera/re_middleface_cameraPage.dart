...
import 'dart:async';
import 'package:acne_camera/camera_page/re-take/front_camera/re_middleface_cameraPage.dart';
...
class re_middleface_backcameraPage extends StatefulWidget {
  const re_middleface_backcameraPage(
      {Key? key,
  ...
  @override
  re_middleface_backcameraPageState createState() =>
      re_middleface_backcameraPageState();
}

class re_middleface_backcameraPageState
    extends State<re_middleface_backcameraPage> {
            ...
            children: [
              ...
              FloatingActionButton(
                onPressed: () async {
                  Navigator.of(context).push(
                    MaterialPageRoute(
                      builder: (context) => re_middleface_frontcameraPage(
