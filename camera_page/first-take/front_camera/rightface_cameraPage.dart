...
class rightface_frontcameraPage extends StatefulWidget {
  const rightface_frontcameraPage({
    Key? key,
  ...
  @override
  rightface_frontcameraPageState createState() =>
      rightface_frontcameraPageState();
}

class rightface_frontcameraPageState extends State<rightface_frontcameraPage> {
  late CameraController _controller;
            ...
            children: [
              ...
              FloatingActionButton(
                onPressed: () async {
                  Navigator.of(context).push(
                    MaterialPageRoute(
                      builder: (context) => rightface_backcameraPage(
